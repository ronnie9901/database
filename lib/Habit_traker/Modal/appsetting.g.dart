...
extension AppSettingQueryFilter
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterFilterCondition> firstdateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterFilterCondition> firstdateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterFilterCondition> firstdateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AppSettingQuerySortBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByFirstdate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstdate', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByFirstdateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQuerySortThenBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByFirstdate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstdate', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByFirstdateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstdate', Sort.desc);
    });
  }
...
extension AppSettingQueryWhereDistinct
  ...
  QueryBuilder<AppSetting, AppSetting, QDistinct> distinctByFirstdate() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQueryProperty
  ...
  QueryBuilder<AppSetting, DateTime?, QQueryOperations> firstdateProperty() {
    return QueryBuilder.apply(this, (query) {
